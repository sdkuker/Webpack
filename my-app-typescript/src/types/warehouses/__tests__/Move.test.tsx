...
it('constructor', () => {
    ...
    let myMove = new Move('1', myOrder, 'Germany', myTurnId, myGameId);
...
it('piece type F', () => {
    ...
    let myMove = new Move('2', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
})
it('piece type Fleet', () => {
    let myOrder = 'Fleet London Holds';
    let myMove = new Move('3', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
})

it('piece type f', () => {
    let myOrder = 'f London Holds';
    let myMove = new Move('4', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
})
it('piece type fleet', () => {
    let myOrder = 'fleet London Holds';
    let myMove = new Move('5', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
})

it('piece type A', () => {
    let myOrder = 'A London Holds';
    let myMove = new Move('6', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
})
it('piece type Army', () => {
    let myOrder = 'Army London Holds';
    let myMove = new Move('7', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
})

it('piece type a', () => {
    let myOrder = 'a London Holds';
    let myMove = new Move('8', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
})
it('piece type army', () => {
    let myOrder = 'army London Holds';
    let myMove = new Move('9', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
})

it('invalid piece type', () => {
    let myOrder = 'george London Holds';
    let myMove = new Move('10', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toBeUndefined();
})

it('good current Location', () => {
    let myOrder = 'Army London Holds';
    let myMove = new Move('11', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
...
it('Bad current Location', () => {
    ...
    let myMove = new Move('12', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
...
it('Good hold', () => {
    let myOrder = 'Army London Holds';
    let myMove = new Move('13', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
    expect(myMove.currentLocationName).toEqual('London');
...
it('Bad action', () => {
    ...
    let myMove = new Move('14', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
    expect(myMove.currentLocationName).toEqual('London');
...
it('Good army move', () => {
    ...
    let myMove = new Move('15', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
    expect(myMove.currentLocationName).toEqual('London');
...
it('Good fleet move', () => {
    ...
    let myMove = new Move('16', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
    expect(myMove.action).toEqual(MoveAction.MovesTo);
    expect(myMove.endingLocationName).toEqual('Edinburgh');
...
it('Bad army move - ending location', () => {
    ...
    let myMove = new Move('17', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Army);
    expect(myMove.currentLocationName).toEqual('London');
    expect(myMove.action).toEqual(MoveAction.MovesTo);
...
it('Good convoy', () => {
    ...
    let myMove = new Move('18', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
...
it('Bad convoy - convoy verb', () => {
    ...
    let myMove = new Move('19', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
    expect(myMove.action).toBeUndefined();
    expect(myMove.endingLocationName).toBeUndefined();
...
it('Bad convoy - bad secondary piece', () => {
    ...
    let myMove = new Move('20', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
    expect(myMove.action).toEqual(MoveAction.Convoys);
    expect(myMove.endingLocationName).toBeUndefined();
...
it('Bad convoy - bad secondary current location', () => {
    ...
    let myMove = new Move('21', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
    expect(myMove.action).toEqual(MoveAction.Convoys);
    expect(myMove.endingLocationName).toBeUndefined();
...
it('Bad convoy - bad secondary action', () => {
    ...
    let myMove = new Move('22', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
    expect(myMove.action).toEqual(MoveAction.Convoys);
    expect(myMove.endingLocationName).toBeUndefined();
...
it('Bad convoy - bad secondary ending location', () => {
    ...
    let myMove = new Move('23', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
    expect(myMove.action).toEqual(MoveAction.Convoys);
    expect(myMove.endingLocationName).toBeUndefined();
...
it('Good support', () => {
    ...
    let myMove = new Move('24', myOrder, 'Germany', myTurnId, myGameId);
    expect(myMove.pieceType).toEqual(PieceTypes.Fleet);
    expect(myMove.currentLocationName).toEqual('London');
